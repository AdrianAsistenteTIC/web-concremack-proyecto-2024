      ...
      <div class="col-lg-9 col-12">
        <div class="d-flex flex-column gap-6">
          <div class="d-flex flex-column gap-4">
            <h1 class="text-white-stable display-4 mb-0">
              TITULO
            </h1>
            <p class="mb-0 text-white-50 lead px-lg-10" style="text-align: justify;">
            <h1 class="mb-5 display-5 text-white-stable">
              TEXTO 1
              <span class="text-pattern-line text-warning">TEXTO 2</span>
            </h1>
            </p>
          </div>
        </div>
