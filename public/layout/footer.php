        ...
        <div class="mb-7 mb-xl-0">
          <div class="mb-4">
            <a href="index.php" rel="noopener noreferrer">
              <image src="assets/images/logo/Logo-Concremack-266.png" class="text-inverse" alt="CONCREMACK"
                title="CONCREMACK" />
            </a>
          </div>
          <p class="mb-5">
          ...
          <div class="d-flex mb-4">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-telephone text-danger" viewBox="0 0 16 16">
                <path
          ...
          <div class="d-flex mb-4">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-envelope-check text-danger" viewBox="0 0 16 16">
                <path
            ...
            <div class="position-relative">
              <div class="mb-3 pb-2 d-flex justify-content-between border-bottom border-bottom-lg-0">
                ...
                <a class="d-block d-lg-none stretched-link text-inherit" data-bs-toggle="collapse"
                  href="#collapseLanding" rel="noopener noreferrer" role="button" aria-expanded="false"
